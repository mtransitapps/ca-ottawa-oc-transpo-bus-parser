...
public class OttawaOCTranspoBusAgencyTools extends DefaultAgencyTools {
	...
	private static final String ROUTE_505 = EMPTY; // TODO
	private static final String ROUTE_506 = EMPTY; // TODO
	...
	private static final String ROUTE_615 = EMPTY; // TODO
	private static final String ROUTE_616 = EMPTY; // TODO
	...
	public String getRouteLongName(@NotNull GRoute gRoute) {
		if (StringUtils.isEmpty(gRoute.getRouteLongName())) {
			...
			if (!CharUtils.isDigitsOnly(rsnS)) {
				...
				case 615: return ROUTE_615;
				case 616: return ROUTE_616;
	...
	public String getRouteColor(@NotNull GRoute gRoute) {
		if (StringUtils.isEmpty(gRoute.getRouteColor())) {
			...
			throw new MTLog.Fatal("No route color for '%s'!", gRoute);
		}
